...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "CATEGORY_MESSAGE_TITLE" => "Comments",
        ...
        "FORM_AUTOCOMPLETE" => "Y",
        "FORM_ID" => "service-modal",
        "FORM_SUBMIT_VALUE" => "Send",
        "HIDE_ASTERISK" => "N",
        "HIDE_FIELD_NAME" => "N",
        "MAIL_SEND_USER" => "N",
        "MAIL_SUBJECT_ADMIN" => "#SITE_NAME#: Message from the feedback form in the Services",
        "OK_TEXT" => "Message sent successfully",
        "OK_TEXT_AFTER" => "Leave application for the service",
