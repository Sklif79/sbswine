...
$APPLICATION->SetPageProperty("keywords", "адрес магазинов вина минск");
$APPLICATION->SetPageProperty("title", "Контакты ООО \"Сервисбытснаб\"");
$APPLICATION->SetPageProperty("description", "Сеть магазинов ВИНО от импортера");
$APPLICATION->SetTitle("Контакты ООО \"Сервисбытснаб\"");
?>
