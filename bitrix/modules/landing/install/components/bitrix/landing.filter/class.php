...
class LandingFilterComponent extends LandingBaseComponent
{
	...
	public function executeComponent()
	{
		...
		if ($init)
		{
			...
			$this->checkParam('BUTTON_ACTION_LINK', '');
			$this->checkParam('BUTTON_ACTION_TITLE', '');

			$this->arParams['FILTER_TYPE'] = trim($this->arParams['FILTER_TYPE']);
			$this->arParams['BUTTON_ACTION_LINK'] = trim($this->arParams['BUTTON_ACTION_LINK']);
			$this->arParams['BUTTON_ACTION_TITLE'] = trim($this->arParams['BUTTON_ACTION_TITLE']);
