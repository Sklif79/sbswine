...
<form action="<?= $uriSave->getUri();?>" method="post" class="ui-form ui-form-gray-padding landing-form-collapsed landing-form-settings" id="landing-site-set-form">
					...
					<td class="ui-form-right-cell">
						<div class="landing-form-site-name-block" id="ui-editable-domain">
							...
							<?else:?>
								...
								<input type="text" name="fields[CODE]" value="<?= $row['CODE']['CURRENT']?>" class="ui-input landing-input-align-top">
							<?endif;?>
						</div>
					</td>
				</tr>
			<?if (isset($hooks['B24BUTTON'])):
				...
				<tr>
					...
					<td class="ui-form-right-cell">
						<div class="landing-form-flex-box">
							...
							<a href="<?= SITE_DIR?>crm/button/" class="landing-form-input-right" target="_top">
				...
				<?/*<tr class="landing-form-hidden-row">
					<td class="ui-form-label ui-form-label-align-top">
						<span>favicon</span>
						<span class="landing-form-favicon-info"></span>
					</td>
					<td class="ui-form-right-cell">
						<div class="landing-form-page-favicon"></div>
					</td>
				</tr>*/?>
			<?if (isset($hooks['UP'])):
	...
	<div class="<?if ($request->get('IFRAME') == 'Y'){?>landing-edit-footer-fixed <?}?>pinable-block">
		<div class="landing-form-footer-container">
			...
			<a class="landing-button-link"<?if ($request->get('IFRAME') == 'Y'){?> id="action-close"<?}?> href="<?= $arParams['PAGE_URL_SITES']?>">
