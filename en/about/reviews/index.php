...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CATEGORY_MESSAGE_TITLE" => "Message",
		...
		"HIDE_FIELD_NAME" => "N",
		"MAIL_SEND_USER" => "N",
		"MAIL_SUBJECT_ADMIN" => "#SITE_NAME#: Message from the form in reviews",
		"OK_TEXT_TITLE" => "Thanks for your feedback!",
		"OK_TEXT" => "Your opinion is very important to us. Thank you for sharing it with us..",
		"OK_TEXT_AFTER" => "",
		...
		"CATEGORY_ITEM_NAME_TITLE" => "Header",
