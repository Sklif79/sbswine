...
$APPLICATION->SetPageProperty("contentClass", "advanced-page__small-single");
...
<a href="<?=$arParams["SEF_FOLDER"]?>">
    <div class="back-button">
        <div class="back-button__wrapper">
            ...
            <div class="back-button__text"><?=GetMessage("NEWS_PAGE_LINK_PREV")?></div>
        </div>
    </div>
</a>
<div class="advanced-page__content advanced-page__content--single">
    ...
    <?if($GLOBALS["CONSULTANT_INFO"]):?>
    <div class="news-page-inner-item__block">
        <div class="h3 upper"><?=GetMessage("CONSULTANTS_PAGE_TITLE_CONSULTANT")?></div>
            <?
            $GLOBALS['arrFiletId']['ID'] = $GLOBALS["CONSULTANT_INFO"]["ID"];
            $APPLICATION->IncludeComponent(
                "bitrix:news.list",
                "consultants",
                array(
                    "IBLOCK_ID" => $GLOBALS["CONSULTANT_INFO"]["IBLOCK_ID"],
                    "NEWS_COUNT" => "1",
...
<?$APPLICATION->IncludeFile(
    SITE_DIR . 'include/services/form.php',
    Array(),
