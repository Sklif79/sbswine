...
class webdebug_utilities extends CModule {
	...
	function __construct() {
		...
		$this->PARTNER_NAME = GetMessage("WEBDEBUG_UTILITIES_PARTNER_NAME");
		$this->PARTNER_URI = GetMessage("WEBDEBUG_UTILITIES_PARTNER_URI");
		$this->MODULE_NAME = GetMessage("WEBDEBUG_UTILITIES_MODULE_NAME");
		$this->MODULE_DESCRIPTION = GetMessage("WEBDEBUG_UTILITIES_MODULE_DESCR");
	}
	...
	function DoInstall() {
		...
		RegisterModuleDependences("iblock", "OnAfterIBlockUpdate", $this->MODULE_ID, "CWD_Util_Handler", "OnAfterIBlockUpdate");
		RegisterModuleDependences("iblock", "OnIBlockDelete", $this->MODULE_ID, "CWD_Util_Handler", "OnIBlockDelete");
		RegisterModuleDependences("iblock", "OnAfterIBlockDelete", $this->MODULE_ID, "CWD_Util_Handler", "OnAfterIBlockDelete");
		...
		RegisterModuleDependences('main', 'OnAdminListDisplay', $this->MODULE_ID, 'CWD_Util_Handler', 'OnAdminListDisplay');
		return true;
	}
	...
	function DoUninstall() {
		...
		UnRegisterModuleDependences("iblock", "OnAfterIBlockUpdate", $this->MODULE_ID, "CWD_Util_Handler", "OnAfterIBlockUpdate");
		UnRegisterModuleDependences("iblock", "OnIBlockDelete", $this->MODULE_ID, "CWD_Util_Handler", "OnIBlockDelete");
		UnRegisterModuleDependences("iblock", "OnAfterIBlockDelete", $this->MODULE_ID, "CWD_Util_Handler", "OnAfterIBlockDelete");
		...
		UnRegisterModuleDependences('main', 'OnAdminListDisplay', $this->MODULE_ID, 'CWD_Util_Handler', 'OnAdminListDisplay');
		$this->UnInstallFiles();
		$this->UnInstallDB();
