;(function() {
	...
	BX.Landing.UI.Panel.URLList.prototype = {
		...
		showSites: function(options)
		{
			...
			this.getSites(options).then(function(sites) {
		...
		showBlocks: function(options)
		{
			...
			this.getBlocks(currentLandingId, options).then(function(blocks) {
		...
		{
			this.onChange({type: "block", id: id, name: name});
		},
		...
		{
			this.onChange({type: "landing", id: id, name: name});
		},
		...
		{
			this.onChange({type: "system", id: "_" + id, name: name});
		},
